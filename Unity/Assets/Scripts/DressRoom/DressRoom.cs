...
public class DressRoom : MonoBehaviour
{
	...
	private int AnimatorIdleState = Animator.StringToHash("Base Layer.idle");
	private int AnimatorHeloState = Animator.StringToHash("Base Layer.helo");
	private int AnimatorHoreState = Animator.StringToHash("Base Layer.hore");
...
//#endif
	...
	private bool showInfiniteProgress = false;
	public static void ShowInfiniteProgres(bool visible)
	{
		if (dressRoom)
		{
			dressRoom.showInfiniteProgress = visible;
		}
 	}
	...
	private void OnGUI()
	{
		...
		{
			UIProgressBarSmall.Instance.UpdateError(0, 0, Screen.width, Screen.height * 0.0084f, 100);
		}
        ...
        if (_isAvatarEditorReady == false)
        {
            ...
            {    
				UIProgressBarSmall.Instance.Update(0, 0, Screen.width, Screen.height * 0.0084f, "", generator.Progress, 13);
            }
        }

		if (showInfiniteProgress)
		{
			UIProgressBarSmall.Instance.UpdateInfinite(0, 0, 100, Screen.height * 0.0084f);
        }
    ...
    private void ProcessInput()
    {
        if (Application.platform != RuntimePlatform.Android && Application.platform != RuntimePlatform.IPhonePlayer)
        {
            if (Input.GetKey(KeyCode.Q))
            {
				...
				TransitionAnimator(generator, _character, AnimatorHeloState);
            }
            ...
            if (Input.GetKey(KeyCode.E))
            {
				...
				TransitionAnimator(generator, _character, AnimatorHoreState);
            }
    ...
    private void UpdateAvatar()
    {
        if (_changeNewCharacter)
        {
			...
			Debug.LogWarning("=> Generate New Character");
            ...
            if (_character != null)
            {
				...
				if (_character.GetComponent<Animator>() != null)
				{
					...
					animator.Play(AnimatorIdleState);
        ...
        {
			Debug.LogWarning("=> Update Avatar");
    ...
    {
		string avatarURL = AvatarConfig.GetDefaultAvatarConfigV2(id);//PopBloopSettings.GetAvatarConfigurationURL(id);
        
        WWW avatarWWW = new WWW(avatarURL);
        Debug.Log("Get Avatar Configuration: " + avatarURL);
        ...
        else
        {
			...
			var config = AvatarConfig.CreateObject(avatarWWW.text);
			string json = config.configurations;
			//string json2 = "[{'tipe':'Skin','color':'1'},{'tipe':'Hand','element':'male_hand','material':'m_m_to_tshirt_green01','id':'53e8bf4609bf10a021000000'},{'tipe':'Gender','element':'male_base','material':'','id':'53e8c0b509bf10b81a000000'},{'tipe':'Hair','element':'male_c_ha_hair04','material':'m_ha_hair04','id':'53e8ce5209bf101423000000'},{'tipe':'Body','element':'male_c_m_m_to_tshirt01','material':'m_m_to_tshirt_green01','id':'53e8d02909bf101423000002'},{'tipe':'Pants','element':'male_c_m_l_bo_pantscasualslim01','material':'m_m_bo_pantscasualslim_blue01','id':'53e8aeda09bf108c20000005'},{'tipe':'Shoes','element':'male_c_m_fo_sneakersconverse01','material':'m_m_fo_sneakersconverse_black01','id':'53e8aa0009bf10bc1d000000'},{'tipe':'Face','element':'male_head','material':'','id':'53e8c51109bf10b807000004','eye_brows':'brows_11_01','id_EyeBrows':'53e8cd4b09bf10f013000004','eyes':'eyes_b_06_02','id_Eyes':'53e8cb7309bf10f013000000','lip':'lips_b_06_01','id_Lip':'53e8cc2b09bf10f013000002'}]";
			//string json3 = "[{'tipe':'Skin','color':'1'},{'tipe':'Hand','element':'male_hand','material':'m_m_to_tshirt_green01','id':'53e8bf4609bf10a021000000'},{'tipe':'Gender','element':'male_base','material':'','id':'53e8c0b509bf10b81a000000'},{'tipe':'Body','element':'male_c_m_m_to_tshirt01','material':'m_m_to_tshirt_green01','id':'53ec770209bf10dc06000197'},{'tipe':'Pants','element':'male_c_m_m_bo_pantscasualslim01','material':'m_m_bo_pantscasualslim_blue01','id':'53ec754509bf109806000002'},{'tipe':'Shoes','element':'male_c_m_fo_sneakersconverse01','material':'m_m_fo_sneakersconverse_black01','id':'53ec783909bf10d015000000'},{'tipe':'Face','element':'male_head','material':'','id':'53e8c51109bf10b807000004','eye_brows':'brows_11_01','id_EyeBrows':'53e8cd4b09bf10f013000004','eyes':'eyes_b_06_02','id_Eyes':'53e8cb7309bf10f013000000','lip':'lips_b_06_01','id_Lip':'53e8cc2b09bf10f013000002'},{'tipe':'Hair','element':'male_c_ha_hair04','material':'m_ha_hair04','id':'53e8ce5209bf101423000000'}]";
            Debug.Log(string.Format("GetAvatarConfigurationUrl: {0} => Avatar JSON: {1}", avatarURL, json));

			bool update = generator.ChangeCharacterFromJSON(json);

			string currentConfig = generator.GetCurrentCharacterConfig();
			Debug.LogWarning("Character Config: "+ currentConfig);
			...
			else
			{
	            ...
	            else
	            {
	                ...
	                Debug.Log(string.Format("GetEditorAnimationsConfigurationURL: {0} => Animation JSON: {1} ", animationURL, animation));
    ...
    {
        Debug.Log("Change Avatar with PlayerId: " + id);
