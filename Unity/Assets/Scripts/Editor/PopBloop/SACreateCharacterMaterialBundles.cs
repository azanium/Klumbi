...
public class SACreateCharacterMaterialBundles {
	...
	static void Execute()
	{
        CreateCharacterMaterialBundle(BuildTarget.WebPlayer);
	}

    [MenuItem("PopBloop/Assets/Android/3. Create Character Material Bundles")]
    static void ExecuteAndroid()
    {
        CreateCharacterMaterialBundle(BuildTarget.Android);
    }

    [MenuItem("PopBloop/Assets/iOS/3. Create Character Material Bundles")]
    static void ExecuteiOS()
    {
        CreateCharacterMaterialBundle(BuildTarget.iPhone);
    }

    static void CreateCharacterMaterialBundle(BuildTarget target)
    {
        ...
        foreach (Object o in Selection.GetFiltered(typeof(Object), SelectionMode.DeepAssets))
        {
            ...
            BuildPipeline.BuildAssetBundle(asset, null, Path.Combine(path, name + ".unity3d"), BuildAssetBundleOptions.CollectDependencies, target);
        ...
        EditorUtility.DisplayDialog("PopBloop", "Material(s) creation completed\n" + path, "OK");
    }
