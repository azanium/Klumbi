            ...
            else
            {
                ...
                if (bodyPart == CharacterConstants.BodyPart.Face)
                {
                    ...
                    string lip = map["lip"];
						...
						string eyeBrowsId = map.ContainsKey("id_EyeBrows") ? map["id_EyeBrows"] : "";
						string eyesId = map.ContainsKey("id_Eyes") ? map["id_Eyes"] : "";
						string lipId = map.ContainsKey("id_Lip") ? map["id_Lip"] : "";

                    config.face = element;
						config.eyeBrowsId = eyeBrowsId;
                    config.eyeBrows = eyeBrows;
                    config.eyes = eyes;
						config.eyesId = eyesId;
                    config.lip = lip;
						config.lipId = lipId;
                    config.faceId = id;
                }
...
public GameObject Generate()
{
    try
    {
        ...
        if (_root.GetComponent<Animation>() != null)
        {
