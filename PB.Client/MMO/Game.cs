...
namespace PB.Client
{
    ...
    using PB.Client.GameStateStrategies;
    using PB.Common;
    ...
    public class Game : IPhotonPeerListener
    {
        ...
        public void SetStateWorldEntered(WorldData worldData)
        {
            ...
            camera.SetViewDistance(worldData.Level.InterestArea);

            this.avatar.SetPositions(this.avatar.InitialPosition, this.avatar.InitialPosition, this.avatar.InitialRotation, this.avatar.InitialRotation);
        ...
        public void OnGetLevelInfo(string worldName, int currentCCU, int maxCCU)
        {
            if (this.Listener.IsDebugLogEnabled)
            {
                this.Listener.LogDebug(this, "Got Level Info with Max CCU: " + maxCCU.ToString());
            }

            this.Listener.OnGetLevelInfo(this, worldName, currentCCU, maxCCU);
        }
